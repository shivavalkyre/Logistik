$(function(){
    $('#dg').edatagrid({
        url: '../control/get_input_biopond.php',
        saveUrl: '../control/save_input_biopond.php',
        updateUrl: '../control/update_input_biopond.php',
        destroyUrl: '../control/delete_input_biopond.php'
    });
});
...
function onBeforeLoad(param) {
    ...
    //alert(kd_supplier);
        ...
        opts.url = '../control/get_input_biopond_active.php';
