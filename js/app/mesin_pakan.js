$(function(){
    $('#dg').edatagrid({
        url: '../control/get_input_mesin_pakan.php',
        saveUrl: '../control/save_input_mesin_pakan.php',
        updateUrl: '../control/update_input_mesin_pakan.php',
        destroyUrl: '../control/delete_input_mesin_pakan.php'
    });
});
...
function onBeforeLoad(param) {
    ...
    //alert(kd_supplier);
        ...
        opts.url = '../control/get_input_mesin_pakan_active.php';
