...
<table id="dg"  class="easyui-datagrid" style="width:100%;height:350px"
            url="../control/get_transaksi_receive.php"
             pagination="true"
        ...
        <thead>
            <tr>
                ...
                <th field="no_terima" width="50">No Penerimaan</th>
                <th field="no_bast" width="50">No BAST</th>
...
<script>
    ...
    function openDialog(title,id){
        ...
        closable:true,
        cache: false,
        href: 'Tambah Penerimaan Barang.php?id='+0+"&title=tambah",
        modal: true,
        ...
        closable:true,
        cache: false,
        href: 'Tambah Penerimaan Barang.php?id='+id+"&title=ubah",
        modal: true,
        onBeforeClose:function(){
            $('#dg').datagrid('reload');
        },
