...
<table id="dg"  class="easyui-datagrid" style="width:100%;height:250px"
            url="../control/get_satuan_barang.php"
    ...
    <script type="text/javascript">
        ...
        function newData(){
            ...
            $('#fm').form('clear');
            url = '../control/save_satuan_barang.php';
        }
        function editData(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = '../control/update_satuan_barang.php?id='+row.id;
            }
        }
        function saveData(){
            $('#fm').form('submit',{
        ...
        function destroyData(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this user?',function(r){
                    if (r){
                        $.post('../control/delete_satuan_barang.php',{id:row.id},function(result){
                            if (result.success){
                                $('#dg').datagrid('reload');    // reload the user data
                            } else {
