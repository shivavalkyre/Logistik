...
<table id="dg"  class="easyui-datagrid" style="width:100%;height:250px"
            url="../control/get_satuan_waktu.php"
            toolbar="#toolbar" pagination="true"
            rownumbers="true" fitColumns="true" singleSelect="true">
        <thead>
            <tr>
                <th field="satuan_waktu" width="50">Satuan</th>
            </tr>
        </thead>
    </table>
    <div id="toolbar">
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px" data-options="closed:true,modal:true,border:'thin',buttons:'#dlg-buttons'">
        <form id="fm" method="post" novalidate style="margin:0;padding:20px 50px">
            <div style="margin-bottom:10px">
                <input name="satuan_waktu" labelposition="top" class="easyui-textbox" required="true" label="Satuan Waktu:" style="width:100%">
            </div>
        </form>
    </div>
    <div id="dlg-buttons">
    ...
    <script type="text/javascript">
        ...
        function newData(){
            ...
            $('#fm').form('clear');
            url = '../control/save_satuan_waktu.php';
        }
        function editData(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = '../control/update_satuan_waktu.php?id='+row.id;
            }
        }
        function saveData(){
            $('#fm').form('submit',{
        ...
        function destroyData(){
            ...
            if (row){
                $.messager.confirm('Confirm','Are you sure you want to destroy this user?',function(r){
                    if (r){
                        $.post('../control/delete_satuan_waktu.php',{id:row.id},function(result){
                            if (result.success){
                                $('#dg').datagrid('reload');    // reload the user data
                            } else {
