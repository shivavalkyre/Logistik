<?php  
    ...
    $sql="update tbl_transaksi set tran_type=1,tanggal='$tgl_penerimaan',no_terima='$no_penerimaan',no_bast='$no_bast',requestor_id='$user_id' where id=$transaksi_id RETURNING id";
